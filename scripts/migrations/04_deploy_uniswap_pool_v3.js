...
async function main() {
  ...
  const Erc721Ltoken = await hre.ethers.getContractFactory("Erc721Ltoken");
  ...
  const UniswapV3TreasuryPool = await hre.ethers.getContractFactory("UniswapV3TreasuryPool");
  ...
  const ltoken = await deployUtil.deployContract(Erc721Ltoken, ltokenArguments, true);
  ...
  treasuryPool = await deployUtil.deployProxy(UniswapV3TreasuryPool, treasuryPoolArguments, true);
